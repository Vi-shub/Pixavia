                ...
                <div className="row onovo-portfolio-items">
                  {modalOpen && (
                    ...
                    >
                      ...
                      {/* Modal Content */}
                      {modalType === "image" && (
                        <img src={modalContent} alt="Project Content" />
                      )}
                      {modalType === "video" && (
                    ...
                    {layout == "grid" && (
                      <div className="onovo-portfolio-item">
                        <div className={masonry ? "image" : "image image-square"} data-onovo-overlay data-onovo-scroll>
                          {item.type === "image" ? (
                            <img className="onovo-hover-3" src={item.content} alt={item.title} />
                          ) : (
                            <div>
                              <img className="onovo-hover-3" src={item.thumbnail} alt={item.title} />
